...
import 'package:uas/model/list_users_model.dart';
import 'package:uas/pages/home/mobileView.dart';
import 'package:uas/pages/home/tabletView.dart';
import 'package:uas/pages/login/login.dart';
import 'package:uas/service/service_app.dart';
    ...
    if (user_id != null && user_id != '') {
      return FutureBuilder(
        builder: ((context, snapshot) {
          ...
          if (_mod[0] != null) {
            return Scaffold(
              backgroundColor: Color.fromARGB(255, 40, 26, 129),
              appBar: AppBar(
              ...
              floatingActionButton: FloatingActionButton(
                backgroundColor: Color.fromARGB(255, 222, 233, 255),
                onPressed: () {
